...
contract MockModule is BaseModule {
    ...
    function requiredFunctions() external pure override returns (bytes4[] memory) {
        ...
        _requiredFunctions[1] = IModuleManager.addModule.selector;
        _requiredFunctions[2] = IModuleManager.removeModule.selector;
        _requiredFunctions[3] = IModuleManager.executeFromModule.selector;
